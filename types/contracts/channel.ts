...
import { ContractAbi } from '../contract-info/channel';
import QueryMethods from '../query/channel';
import BuildExtrinsicMethods from '../build-extrinsic/channel';
import TxSignAndSendMethods from '../tx-sign-and-send/channel';
import MixedMethods from '../mixed-methods/channel';
import EventsClass from '../events/channel';
